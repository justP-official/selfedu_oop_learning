...
class TestAnsDigit(Test):
    ...
    def __init__(self, descr, ans_digit, max_error_digit=0.01):
        ...
        self.validate_number(ans_digit)
        self.ans_digit = ans_digit

        self.validate_number(max_error_digit)
        self.validate_max_error(max_error_digit)
