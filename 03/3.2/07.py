...
GET-запросов на стороне сервера.
...
такой: {"method": "GET", "url": "contact.html"}.
...
Если же ключ method принимает другое значение, например, "POST", то декорированная функция contact должна возвращать
значение None.
