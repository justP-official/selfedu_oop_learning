...
Вас просят реализовать простую имитацию локальной сети, состоящую из набора серверов, соединенных между собой через роутер.
...
class Router:
    ...
    def link(self, server):
        ...
        setattr(server, 'ip', len(self.servers))
...
s1.send_data(Data("Hello", s2.get_ip()))
s2.send_data(Data("Hi", s1.get_ip()))
